...
[TikTok Pixel](https://ads.tiktok.com/help/article/get-started-pixel) is TikTok's conversion tracking tool that helps you measure the effectiveness of your TikTok advertising campaigns by tracking user actions on your website.

### `NEXT_PUBLIC_TIKTOK_PIXEL_ID`

- Type: Optional
- Description: Your TikTok Pixel ID. Add it to automatically enable TikTok Pixel tracking across your application.
- Default: `-`
- Example: `D4KRIFBC77U4IAHDO190`

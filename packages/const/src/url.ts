...
export const OFFICIAL_URL = 'https://pho.chat';
export const OFFICIAL_PREVIEW_URL = 'https://pho.chat';
export const OFFICIAL_SITE = 'https://pho.chat';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/thaohienhomes/lobe-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://pho.chat/changelog';
export const DOCKER_IMAGE = 'https://hub.docker.com/r/pho/chat';
...
export const FEEDBACK = 'https://github.com/thaohienhomes/lobe-chat/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://pho.chat/plugins';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/thaohienhomes/lobe-chat/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/thaohienhomes/lobe-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/thaohienhomes/lobe-chat-agents';
...
export const BASE_PROVIDER_DOC_URL = 'https://pho.chat/docs/usage/providers';

...
Write the full article now in markdown format.`;
        ...
        // All retries failed
        setProgressLines((prev) => [...prev, `❌ Lỗi viết bài: ${lastError?.message || 'Unknown error'}. Vui lòng thử lại.`]);
        message.error(`Lỗi viết bài: ${lastError?.message || 'Server timeout'}. Bấm "Viết bài" để thử lại.`);

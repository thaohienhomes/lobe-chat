...
// ── DailyTierRateLimiter — REMOVED ──────────────────────────────
// Daily tier limits are now enforced solely by atomicAcquireTierSlot()
// in credits.ts (PostgreSQL atomic UPDATE). See rate-limit.ts for details.

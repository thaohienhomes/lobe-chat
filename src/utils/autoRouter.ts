...
const VIETNAMESE_REGEX = /[àáâãèéêìíòóôõùúýăđĩũơưạảấầẩẫậắằẳẵặẹẻẽếềểễệỉịọỏốồổỗộớờởỡợụủứừửữựỳỵỷỹ]/i;
...
const CATEGORY_KEYWORDS: Record<PromptCategory, string[]> = {
  ...
  translation: ['dịch', 'interpret', 'localize', 'translate', 'translation'],
};
 ...
 */
export function classifyPrompt(query: string, hasAttachments = false): PromptClassification {

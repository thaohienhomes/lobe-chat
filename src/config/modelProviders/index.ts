 ...
 *
 * Per SPECS_BUSINESS.md: OpenRouter is the PRIMARY and ONLY provider for pho.chat
 * - All other providers are disabled by default
 * - This ensures all chat requests go through OpenRouter API
 * - Phở Points deduction works correctly with centralized billing
 *
 * OpenRouter is placed FIRST and is the only one with enabled: true
 */
export const DEFAULT_MODEL_PROVIDER_LIST = [
  ...
  { ...AzureProvider, chatModels: [], enabled: false },
  { ...AzureAIProvider, enabled: false },
  { ...OllamaProvider, enabled: false },
  { ...OllamaCloudProvider, enabled: false },
  { ...VLLMProvider, enabled: false },
  { ...XinferenceProvider, enabled: false },
  ...
  { ...FalProvider, enabled: false },
  { ...HuggingFaceProvider, enabled: false },
  { ...CloudflareProvider, enabled: false },
  { ...GithubProvider, enabled: false },
  { ...NewAPIProvider, enabled: false },
  { ...BflProvider, enabled: false },
  { ...NovitaProvider, enabled: false },
  ...
  { ...UpstageProvider, enabled: false },
  { ...XAIProvider, enabled: false },
  { ...JinaProvider, enabled: false },
  { ...SambaNovaProvider, enabled: false },
  { ...CohereProvider, enabled: false },
  { ...V0Provider, enabled: false },
  { ...QwenProvider, enabled: false },
  { ...WenxinProvider, enabled: false },
  { ...TencentcloudProvider, enabled: false },
  { ...HunyuanProvider, enabled: false },
  { ...ZhiPuProvider, enabled: false },
  { ...SiliconCloudProvider, enabled: false },
  { ...ZeroOneProvider, enabled: false },
  { ...SparkProvider, enabled: false },
  { ...SenseNovaProvider, enabled: false },
  { ...StepfunProvider, enabled: false },
  { ...BaichuanProvider, enabled: false },
  { ...VolcengineProvider, enabled: false },
  { ...MinimaxProvider, enabled: false },
  { ...LMStudioProvider, enabled: false },
  { ...InternLMProvider, enabled: false },
  { ...HigressProvider, enabled: false },
  { ...GiteeAIProvider, enabled: false },
  { ...TaichuProvider, enabled: false },
  { ...Ai360Provider, enabled: false },
  { ...Search1APIProvider, enabled: false },
  { ...InfiniAIProvider, enabled: false },
  { ...AkashChatProvider, enabled: false },
